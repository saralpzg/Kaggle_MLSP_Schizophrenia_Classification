...
def load_data(current_folder=False):
    if current_folder:
        path = ""
    else:
        path = "../"
    ...
    trainFNC = pd.read_csv(f"{path}data/train_FNC.csv")
    trainSBM = pd.read_csv(f"{path}data/train_SBM.csv")
    train_labels = pd.read_csv(f"{path}data/train_labels.csv")
    ...
    testSBM = pd.read_csv(f"{path}data/test_SBM.csv")
